...
Or using the package `acdcquery`

```{r, eval = FALSE}
library(acdcquery)

ted_dir <- "path/to/data"
# Download the latest version:
download_ted(ted_dir)

# OR update an existing version to the newest version
ted_filepath <- "path/to/data/ted.db"
update_ted(ted_filepath)
```
